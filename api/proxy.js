 ...
 * own vendor session (FINTRAC / Rippling); `upstreamApiKey` forwards a
 * personal AI key from Settings. Returns the raw Response so callers can
 * stream. Throws ProxyError only when the proxy itself rejects the call.
 */
