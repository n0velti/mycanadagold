...
export function dailyReceiptStatus(summary) {
  ...
  if (summary.checked === 0) return { label: 'Daily check', value: 'Not checked', tone: undefined };
  return { label: 'Daily check', value: `${summary.checked}/${summary.cells} checked`, tone: undefined };
}
